...
public class EmployeeProfile : Profile
{
    public EmployeeProfile()
    {
        CreateMap<Employee, EmployeeVM>()
            ...
            .ForMember(vm => vm.CompanyName, opt => opt.MapFrom(e => e.Company.Name))
            .ForMember(vm => vm.MainCompanyName, opt => opt.MapFrom(e => e.Company.MainCompany.Name))
            .ForMember(vm => vm.CountryId, opt => opt.MapFrom(e => e.Country.Id))
            .ForMember(vm => vm.CountryCode, opt => opt.MapFrom(e => e.Country.Code))
            .ForMember(vm => vm.CountryName, opt => opt.MapFrom(e => e.Country.Name))
            ;
