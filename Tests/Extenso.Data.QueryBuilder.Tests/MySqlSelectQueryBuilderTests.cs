...
{
    public class MySqlSelectQueryBuilderTests
    {
        [Fact]
        public void SampleQuery()
        {
            var query = new MySqlSelectQueryBuilder()
                .SelectAll()
                .From("Products")
            ...
            string expected = "SELECT `Products`.* FROM `Products` INNER JOIN `Categories` ON `Products`.`CategoryId` = `Categories`.`Id` WHERE `Products`.`Name` LIKE 'A%' ORDER BY `Products`.`Name` ASC LIMIT 25";
        ...
        public void Skip()
        {
            ...
            string expected = "SELECT `Log`.* FROM `Log` ORDER BY `Log`.`DateCreatedUtc` DESC LIMIT 100,25";
            string actual = query.BuildQuery();
        ...
        public void Take()
        {
            ...
            string expected = "SELECT `Products`.* FROM `Products` LIMIT 25";
            string actual = query.BuildQuery();
