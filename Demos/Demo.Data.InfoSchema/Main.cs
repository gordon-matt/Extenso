...
public partial class Main : Form
{
    ...
    [System.Diagnostics.CodeAnalysis.SuppressMessage("Style", "IDE1006:Naming Styles", Justification = "Exception to naming rule for WinForms event handlers.")]
    private void cmdDataSource_SelectedIndexChanged(object sender, EventArgs e) => cmbSchema.Enabled = SelectedDataSource != DataSource.MySql;
    ...
    private void Main_Load(object sender, EventArgs e) => cmdDataSource.DataSource = EnumExtensions.GetValues<DataSource>();
