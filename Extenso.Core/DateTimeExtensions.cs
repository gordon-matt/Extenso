...
public static class DateTimeExtensions
{
    ...
    public static DateTime ParseUnixTimestamp(int unixTimestamp) => DateTimeOffset.FromUnixTimeSeconds(unixTimestamp).DateTime;//return new DateTime(1970, 1, 1, 0, 0, 0, 0)//    .AddSeconds(unixTimestamp)//    .ToLocalTime();
    ...
    public static DateTime StartOfMonth(this DateTime source) => new(source.Year, source.Month, 1, 0, 0, 0, source.Kind);
    ...
    public static DateTime StartOfYear(this DateTime source) => new(source.Year, 1, 1, 0, 0, 0, source.Kind);
    ...
    public static string ToISO8601DateString(this DateTime source) => source.ToString("yyyy-MM-ddTHH:mm:ss.fffK", CultureInfo.InvariantCulture);
    ...
    public static long ToUnixTimestamp(this DateTime source) => new DateTimeOffset(source).ToUnixTimeSeconds();
}