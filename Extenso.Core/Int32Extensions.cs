...
public static class Int32Extensions
{
    ...
    public static bool Between(this int value, int lower, int higher) => value > lower && value < higher;
    ...
    public static bool IsMultipleOf(this int i, int numberToCompare) => i % numberToCompare == 0;
    ...
    public static bool IsNullOrDefault(this int? source) => source is null or default(int);
}