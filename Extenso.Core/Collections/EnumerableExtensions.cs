...
public static class EnumerableExtensions
{
    ...
    extension<T>(IEnumerable<T> source)
    {
        ...
        public HashSet<T> AsHashSet() => source is HashSet<T> ? source as HashSet<T> : source.ToHashSet();
        ...
        public List<T> AsList() => source is List<T> ? source as List<T> : source.ToList();
        ...
        public IEnumerable<T> Descendants(Func<T, IEnumerable<T>> descendBy)
        {
        ...
        public string Join<TResult>(Func<T, TResult> selector, string separator = ",") =>
        ...
        /// <returns></returns>
        public TProp MostOccurring<TProp>(Func<T, TProp> selector) =>
        ...
        /// <param name="selector"></param>
        /// <returns></returns>
        public TProp MostOccurringOrDefault<TProp>(Func<T, TProp> selector) =>
        ...
        public IEnumerable<T> SafeUnion(IEnumerable<T> second)
        {
        ...
        public DataTable ToDataTable(bool convertNullableTypes = false) =>
        ...
        /// <returns>A new System.Data.DataTable containing columns and rows based on the elements in source.</returns>
        public DataTable ToDataTable(string tableName, bool convertNullableTypes = false)
        {
        ...
        public DataTable ToPivotTable<TColumn, TRow, TData>(
        ...
        /// <param name="dataSelector">A function to extract values from the elements which are to determine the data.</param>
        /// <returns>A System.Data.DataTable with the columns, rows and data determined by the given selector functions.</returns>
        public DataTable ToPivotTable<TColumn, TRow1, TRow2, TData>(
            Func<T, TColumn> columnSelector,
        ...
        /// <param name="dataSelector">A function to extract values from the elements which are to determine the data.</param>
        /// <returns>A System.Data.DataTable with the columns, rows and data determined by the given selector functions.</returns>
        public DataTable ToPivotTable<TColumn, TRow1, TRow2, TRow3, TData>(
            Func<T, TColumn> columnSelector,
            Expression<Func<T, TRow1>> row1Selector,
            Expression<Func<T, TRow2>> row2Selector,
