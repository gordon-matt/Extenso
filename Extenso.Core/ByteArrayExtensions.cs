...
namespace Extenso
{
    ...
    public static class ByteArrayExtensions
    {
        ...
        public static string Base64Serialize(this byte[] source, bool prependLength = false)
        {
            if (prependLength)
            {
                return $"{source.Length}:{Convert.ToBase64String(source, 0, source.Length, Base64FormattingOptions.None)}";
            }
            else
            {
        ...
        public static MemoryStream ToStream(this byte[] source)
        {
