...
{
    private static readonly Lazy<HashSet<(MySqlDbType, Type)>> netTypes;
    private static readonly Lazy<HashSet<(MySqlDbType, DbType)>> dbTypes;
    private static readonly Lazy<HashSet<(MySqlDbType, SqlDbType)>> sqlDbTypes;
    ...
    static MySqlDbTypeConverter()
    {
        netTypes = new Lazy<HashSet<(MySqlDbType, Type)>>(() => [
            ...
            (MySqlDbType.Geometry, typeof(object)),
            //(MySqlDbType.Geometry, typeof(DbGeometry)),
        ...
        {
            var hashSet = new HashSet<(MySqlDbType, SqlDbType)>
            {
    ...
    public static Type ToSystemType(MySqlDbType mySqlDbType) => netTypes.Value.First(x => x.Item1 == mySqlDbType).Item2;

    public static DbType ToDbType(MySqlDbType mySqlDbType) => dbTypes.Value.First(x => x.Item1 == mySqlDbType).Item2;

    public static SqlDbType ToSqlDbType(MySqlDbType mySqlDbType) => sqlDbTypes.Value.First(x => x.Item1 == mySqlDbType).Item2;
}