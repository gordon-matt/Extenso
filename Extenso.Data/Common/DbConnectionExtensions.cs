...
public static class DbConnectionExtensions
{
    extension(DbConnection connection)
    {
        ...
        public int ExecuteScalar(string queryText, params DbParameter[] parameters)
        {
        ...
        /// <param name="queryText">The T-SQL statement to execute.</param>
        /// <returns>The first column of the first row in the result set.</returns>
        public T ExecuteScalar<T>(string queryText, params DbParameter[] parameters)
        {
            bool alreadyOpen = connection.State != ConnectionState.Closed;
        ...
        public int ExecuteNonQuery(string queryText, params DbParameter[] parameters)
        {
            bool alreadyOpen = connection.State != ConnectionState.Closed;
        ...
        public DbProviderFactory GetDbProviderFactory() => connection is SqlConnection ? SqlClientFactory.Instance : DbProviderFactories.GetFactory(connection);// Only use reflection as last option//return (DbProviderFactory)connection.GetPrivatePropertyValue("DbProviderFactory");
        ...
        /// <param name="parameters"></param>
        /// <returns></returns>
        public DataSet ExecuteStoredProcedure(string storedProcedure, IEnumerable<DbParameter> parameters) => connection.ExecuteStoredProcedure(storedProcedure, parameters, out _);
        ...
        public DataSet ExecuteStoredProcedure(
            string storedProcedure, IEnumerable<DbParameter> parameters, out Dictionary<string, object> outputValues)
        {
            using var command = connection.CreateCommand();
        ...
        /// </param>
        /// <returns>The number of rows affected.</returns>
        public int Insert<T>(T entity, string tableName, string schema = null, IDictionary<string, string> mappings = null)
        {
        ...
        /// </param>
        /// <returns>The number of rows affected.</returns>
        public int InsertCollection<T>(IEnumerable<T> entities, string tableName, string schema = null, IDictionary<string, string> mappings = null)
        {
            if (mappings.IsNullOrEmpty())
            {
                mappings = typeof(T).GetTypeInfo().GetProperties()
        ...
        /// </param>
        /// <returns>The number of rows affected.</returns>
        public int InsertDataTable(DataTable table, string tableName, string schema = null, IDictionary<string, string> mappings = null)
        {
            if (mappings.IsNullOrEmpty())
            {
        ...
        public bool Validate() => connection.Validate(5);
        ...
        /// <returns>True if successful. Otherwise, false</returns>
        public bool Validate(byte maxTries)
        {
            try
            {
                bool alreadyOpen = connection.State != ConnectionState.Closed;
