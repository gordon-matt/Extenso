...
public static class SqlConnectionExtensions
{
    extension(SqlConnection connection)
    {
        ...
        public ColumnInfoCollection GetColumnData(string tableName, string schema = "dbo")
        {
...
AND T.CONSTRAINT_SCHEMA = @SchemaName";
        ...
        public ColumnInfoCollection GetColumnData(string tableName, IEnumerable<string> columnNames, string schema = "dbo")
        {
...
ORDER BY S.[name]";
        ...
        public ForeignKeyInfoCollection GetForeignKeyData(string tableName, string schema = "dbo")
        {
...
ORDER BY 1,2,3,4";
        ...
        /// <returns></returns>
        public IEnumerable<string> GetTableNames(string databaseName = null, bool includeViews = false)
        {
...
ORDER BY [name]";
        ...
        /// <param name="includeViews"></param>
        /// <returns></returns>
        public IEnumerable<string> GetTableNamesForSchema(string schema, string databaseName = null, bool includeViews = false)
        {
            if (string.IsNullOrEmpty(databaseName))
            {
                databaseName = connection.Database;
...
ORDER BY [name]";
        ...
        /// <param name="databaseName"></param>
        /// <returns></returns>
        public IEnumerable<string> GetViewNames(string databaseName = null)
        {
            if (string.IsNullOrEmpty(databaseName))
            {
                databaseName = connection.Database;
...
ORDER BY [name]";
        ...
        /// <param name="databaseName"></param>
        /// <returns></returns>
        public IEnumerable<string> GetViewNamesForSchema(string schema, string databaseName = null)
        {
            if (string.IsNullOrEmpty(databaseName))
            {
                databaseName = connection.Database;
